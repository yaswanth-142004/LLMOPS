...
class DocumentHandler:
    ...
    def read_pdf(self,pdf_path:str):
        try:
            ...
            self.log.info("PDF read successsfully ",pdf_path=pdf_path,session_id=self.session_id,pages=len(text_chunks))
            ...
            raise DocumentPortalException("Error readin PDf",e) from e 
...
if __name__ == "__main__":
    ...
    pdf_path = r"C:\\Users\\HP\\OneDrive\Desktop\\LLMOPS\\LLMOPS\\Document_portal\\data\\document_analysis\\Attention_is_all_you_need.pdf"
